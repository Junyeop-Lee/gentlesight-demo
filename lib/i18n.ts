...
export const copy = {
  ko: {
    ...
    reportStatusGenerating: "생성 중",
    reportStatusReady: "최신 요약",
    previousNeedsCheck: "함께 남아 있는 확인 필요",
    previousNeedsCheckButton: "남은 확인 {count}개",
    previousNeedsBack: "리포트로 돌아가기",
    ...
    close: "닫기",
    caseSummary: "케이스 현황",
    caseRoutineState: "생활 루틴",
    casePriorityScore: "우선 지수",
  ...
  en: {
    ...
    reportStatusReady: "Current",
    previousNeedsCheck: "Other needs-check items",
    previousNeedsCheckButton: "{count} remaining checks",
    previousNeedsBack: "Back to report",
    ...
    close: "Close",
    caseSummary: "Case status",
    caseRoutineState: "Routine",
    casePriorityScore: "Priority index",
