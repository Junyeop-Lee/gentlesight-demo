...
Use `.claude/skills/gentlesight-ai-api-readiness/SKILL.md` when working on OpenAI integration readiness, AI API keys, `/api/report`, AI-generated guardian report messages, privacy-safe AI boundaries, or PRD issue creation for the AI API plan.
...
- `.claude/agents/ai-api-engineer.md`: OpenAI SDK, Responses API, server-only report generation, route response shape, and fallback behavior.
- `.claude/agents/privacy-contract-reviewer.md`: AI payload privacy boundary, raw-field blocking, bilingual safety, and leakage-prevention tests.
...
| 2026-05-15 | Added AI API readiness harness | `.claude/agents`, `.claude/skills`, `CLAUDE.md` | OpenAI report-readiness PRD, sequential issue workflow, privacy review, and QA handoff |
